...
/**
 * Convertit une image en commandes ESC/POS (norme de facto des imprimantes
 * de tickets/reçus thermiques). Basé sur la commande GS v 0 (raster bit
 * image), documentée publiquement par tous les fabricants compatibles
...
object EscPosRenderer {
    ...
    fun render(bitmap: Bitmap): ByteArray {
        ...
        // Avance papier + coupe (si supportée) : GS V 1
